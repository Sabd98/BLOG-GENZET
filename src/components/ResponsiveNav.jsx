    ...
    <nav className="border-b">
      <div className="flex items-center justify-between h-16 px-4">
        <div className="hidden md:flex items-center space-x-4">
          <div>
            <Sheet>
              ...
              <SheetContent side="left" className=" bg-blue-500 text-white">
                <SheetTitle className="sr-only">Logoipsum</SheetTitle>
          ...
          <h1 className="text-lg font-bold">Logoipsum</h1>
        </div>
        ...
        <div className="relative ">
          {role ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-fit z-[1000] bg-slate-50 rounded-lg">
                <DropdownMenuItem>
                  {role === "Admin" ? (
                    <Link
                      href="/admin/profile"
